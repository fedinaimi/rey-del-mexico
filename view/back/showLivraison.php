...
include "../../controller/clientC.php";
 $livraisonC=new livraisonC();
    ...
    $elementC= null;
    $clientC = new clientC();
    $listlivraison=$livraisonC->afficherlivraison();
                            ...
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <button class="au-btn au-btn-icon au-btn--blue">
                                        <i class="zmdi zmdi-plus"></i>Ajout livraison</button>
                                </div>
                            </div>
                        </div>
						<div class="row">
                                        ...
                                        foreach ($listlivraison as $row)
                                        {
                                         ...
                                         ?>    
                                                ...
                                                <tr valign="middle">
                                                    ...
                                                    $elementC= $clientC->afficherElementClient($row['client']);
 echo $elementC->nom; echo " "; echo $elementC->nom ;
                                                    ?></td>
                                                    
                                                    <td align="center">
             <center>  <form action="modifielivraison.php" method="post" style="position: relative;top: 10px">
    ...
    <center>  <button type="submit" class="badge badge-info">update</button>
                                                    ...
                                                    <td align="center"><?PHP
$elementL= $localC->afficherElementLocal($row['local']);
 echo $elementL->adresse;
?></td>
                                               
                                                   
                                                    <td align="center"><?php echo $row["frais_livraison"].' '.'TND' ?></td>
                                                        <td>
                                                  ...
                                                  <input type="hidden" id="id" name="id" value="<?php echo $row["id"] ?>">
                                                       ...
                                                       <center> <form action="supprimerlivraison.php" method="get">

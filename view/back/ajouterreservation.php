    ...
    if(
        ...
        && isset($_POST['message'])
         ...
         && isset($_POST['local'])) 
         {
             ...
             !empty($_POST['local']))
                {
                $reservation= new reservation($_POST['date'],$_POST['nb_perso'],$_POST['message'] ,0, $client,$_POST['local']);
                            ...
                            <div class="col-lg-9">
                                ...
                                <div id="error">
                                    <?php echo $error; ?>
                                        ...
                                        <div id="erreur"></div>
                                <form action="" name="reservation" id="reservation" method="POST" onclick="return verifReservationr()">
                  <table  align="center">

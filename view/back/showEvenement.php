				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
                        ...
                        <button class="au-btn au-btn-icon au-btn--blue">
                                    <a href="rechercheevenement1.php">   <i class="zmdi zmdi">recherche evenement</i></a></button>
								
								<button class="au-btn--submit" type="submit" value="Recherche Evenement">
									
								</button>
                                <a href="rechercheevenement1.php">
                                </a>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">image evenement</th>
...
<td><img src="../front/assets/img/gallery/<?php echo $evenement['img']; ?>"  alt="image produit "/></td>
...
<td>
<?PHP 
   $elementC= $localC->afficherElementlocal($evenement['local']);
...
<button type="submit" name="effacer" class="au-btn au-btn-icon au-btn--blue">
 ...
 <td class="text-center"> 
<form method="get" action="imprimerevenement.php">
<button type="submit" name="imprimer" class="au-btn au-btn-icon au-btn--blue">
 <i class="zmdi zmdi"></i>imprimer</button>
 <input type="hidden" value=<?PHP echo $evenement['id']; ?> name="id" id="id">
 <input type="hidden" value=<?PHP echo $evenement['img']; ?> name="img" id="img">
 <input type="hidden" value=<?PHP echo $evenement['date']; ?> name="date" id="date">
 <input type="hidden" value=<?PHP echo $evenement['duree']; ?> name="duree" id="duree">
 <input type="hidden" value=<?PHP echo $evenement['description']; ?> name="description" id="description">
 <input type="hidden" value=<?PHP echo $evenement['local']; ?> name="local" id="local">

 <input type="hidden" value=<?PHP echo $evenement['libelle']; ?> name="libelle" id="libelle">
 </form>  
 </td>

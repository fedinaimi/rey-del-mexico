				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
                        ...
                        <button class="au-btn au-btn-icon au-btn--blue">
                                    <a href="findFourni.php">   <i class="zmdi zmdi">recherche Réclamation</i></a></button>
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						...
						<div class="row">
                            <div class="col-lg-9">
								<br>
                                <h2 class="title-1 m-b-25">Informations Réclamations</h2>
...
<td class="text-center"><?PHP echo $rec['message']; ?></td>
<td class="text-center"><?PHP echo $rec['sujet']; ?></td>
<td class="text-center"><?PHP if ($rec['statut']==0){echo "Non traitée";}else {echo "Traitée";}; ?></td>
<td class="text-center"><?PHP  $elementC= $clientC->afficherElementClient($rec['client']);
 echo $elementC->nom; echo " "; echo $elementC->nom ; ?></td>
...
<button type="submit" name="supprimer" class="au-btn au-btn-icon au-btn--blue">
 ...
 <input type="hidden" value=<?PHP echo $rec['id_reclamation']; ?> name="id_reclamation">
 </form>  
 </td>
 <!-- Impression  !-->
 <td class="text-center"> 
<form action="imprimerReclamation.php" method="get">
<button type="submit" name="imprime" id="imprime" class="au-btn au-btn-icon au-btn--blue">
 <i class="zmdi zmdi"></i>Imprimer</button>
 <input type="hidden" value=<?PHP echo $rec['client'];  ?> id="client" name="client">
 <input type="hidden" value=<?PHP echo $rec['message'];  ?> id="message" name="message">
 <input type="hidden" value=<?PHP echo $rec['sujet'];   ?> id="sujet" name="sujet">
 ...
 <td class="text-center"> 
 <button class="au-btn au-btn-icon au-btn--blue">
 <a href="updateReclamation.php?id=<?PHP echo $rec['id_reclamation']; ?>">

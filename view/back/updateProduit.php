			...
			if (isset($_GET['id']))
			{
		       ...
		       ?>
                <form action="" method="POST" >
                 ...
                 <tr>
                    <td><input type="text" name="libelle" id="libelle"  required value = "<?php echo $produit->libelle; ?>"></td>
                </tr>
                <tr>
                    <td><label for="nb_calories">Nb_calories: </label>  </td> 
                </tr> 
                <tr>
                    <td><input type="text" name="nb_calories" id="nb_calories" maxlength="20" required value = "<?php echo $produit->nb_calories; ?>" ></td>
                </tr>
                <tr>

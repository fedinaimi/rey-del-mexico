    ...
    if(
        ...
        && isset($_POST['description'])
         ...
         && isset($_POST['local'])) 
         {
             ...
             !empty($_POST['local']) )
                {
                $evenement= new evenement($_POST['img'],$_POST['libelle'],$_POST['date'],$_POST['duree'],$_POST['description'] ,$_POST['local'] );
                $evenementC->ajouterevenement($evenement);
                echo '<script> alert("ajout avec succées"); </script>';
    ...
    <div class="page-wrapper">
		...
		<div class="page-container">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div id="error">
                                    <?php echo $error; ?>
                                        ...
                                        <div id="erreur"></div>
                                        <form action="" name="evenement" id="evenement" method="POST" onclick= " return verifEvenement()" >
                  <table  align="center">
          ...
          ?>
                ...
                <tr>
                    <td>    <label for="img"> image d'evenment: </label></td> 
                </tr> 

      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->       
           ...
           <!--  Text based logo  -->
          <a class="navbar-brand" href="1.php">Rey Del<br>Méx<span>I</span>co</a> 
...
foreach($listeevenement as $evenement){
  ?>
          <div class="row">
            <div class="col-md-6">
             <div class="mu-about-us-left">     
              <img src="../front/assets/img/gallery/<?php echo $evenement['img']; ?>"  alt="image produit " width="600" height="443">           
              </div>
            </div>
            <div class="col-md-6">

      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right mu-main-nav">
            ...
            <li><a href="1.html#muethos.html">ETHOS</a></li>  
            <li><a href="1.html#mumenu.html">MENU</a></li>  
         ...
         <br>
          ...
          <a href="panier.php"> <img class="right" src="assets/img/panier.png" width="50" height="50" alt="tab img"></a>
                        
           <a href="connexion.php"> <img class="rightT" src="assets/login.jpg" width="50" height="50" alt="tab img"></a> 
           
           <a href="afficherlignecommande.php"> <img class="rightT" src="commande.png" width="150" height="150" alt="tab img"></a>        
...
foreach ($listpanier as $row)
{
        ...
        $S=(intval($row["prixproduit"])*intval($row["qte"]));
        $S1=$S1+(intval($row["prixproduit"])*intval($row["qte"]));
 ...
 ?>
               ...
               <td valign="middle"><center><img width="200px" src="<?php echo $row['imgproduit']; ?>"  /></center></td>
        <th><center><h5 style="position: relative;top: 50px"><?php echo $row["nomproduit"] ?></h5></center></th>
       
            
            <td style="margin: auto"><center><h5 style="position: relative;top: 50px"><?php echo $row["prixproduit"].' '.'TND' ?></h5></center></td>
            ...
            <td><center><h5 style="position: relative;top: 50px"><?php echo $S.' '.'TND' ; ?></h5></center></td>
              ...
              <center>  <form action="confirmerpanier.php" method="post" style="position: relative;top: 50px">
               ...
               <table>
                   ...
                   <center><h3 style="position: relative;left: 900px; bottom :15px;"><?php echo 'Total:'.'    '.'  '. $S1.' '.'TND' ?> </h3>
 </tr>
...
<form action="ajoutercommande.php"  action="supprimertout.php" method="post">
                    ...
                    <input type="hidden" id="nomproduit" name="nomproduit" value="<?php echo  $row["nomproduit"] ?>s ">
                    <input type="hidden" id="prix_tot" name="prix_tot" value="<?php echo $S1 ?>">
                    <input type="hidden" id="qte" name="qte" value=" <?php echo  $row["qte"] ?>s">
